...
namespace UI
{
    public partial class frmEmpleado : Form
    {
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            ...
            if (cmbPuestoTrabajo.Text == "")
            {
                errorProvider1.SetError(cmbPuestoTrabajo, "Seleccione el puesto.");
               cmbPuestoTrabajo.Focus();
                return;
            }
            errorProvider1.SetError(cmbPuestoTrabajo, "");
        ...
        public void limpiarControles()
        {
            ...
            cmbPuestoTrabajo.SelectionLength = -1;
